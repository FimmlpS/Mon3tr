...
public class BENMuscleStrengthen extends AbstractExpressCard {
    public static final String ID = "mon3tr:BENMuscleStrengthen";
    private static final CardStrings cardStrings;

    public BENMuscleStrengthen(){
    ...
    public void expressAppliedToTarget(AbstractCreature target) {
        addToBot(new ApplyPowerAction(target,target,new DexterityPower(target,1),1));
    }
