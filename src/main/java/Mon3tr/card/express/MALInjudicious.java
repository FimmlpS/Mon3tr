...
public class MALInjudicious extends AbstractExpressCard {
    public static final String ID = "mon3tr:MALInjudicious";
    private static final CardStrings cardStrings;

    public MALInjudicious(){
