...
public class StrategyMeltdown extends CustomCard implements HitboxListener {
    public static final String ID = "mon3tr:StrategyMeltdown";
    private static final CardStrings cardStrings;

    public StrategyMeltdown(){
        this(true);
    }

    public StrategyMeltdown(boolean preview){
        ...
        if(preview){
            cardsToPreview = new StrategyOverload(false);
        }
    }
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        ...
        if(!isInAutoplay&&!dontTriggerOnUseCard){
            ...
            addToBot(new ApplyPowerAction(abstractPlayer,abstractPlayer,new MeltdownPower(abstractPlayer)));
            addToBot(new SkipEnemiesTurnAction());
            addToBot(new PressEndTurnButtonAction());
            addToBot(new AbsorbProstsAction(true));
            addToBot(new Mon3trChangeStyleAction(3));
        }
    }
