...
import Mon3tr.modifier.EndingMod;
...
public class PastEndsFutureAction extends AbstractGameAction {
    private AbstractPlayer p;
    private static final float DURATION;

    public PastEndsFutureAction() {
    ...
    private void markLoved(AbstractCard c){
        CardModifierManager.addModifier(c,new EndingMod());
    }
    ...
    public void update() {
        if (this.duration == DURATION) {
            ...
            AbstractDungeon.handCardSelectScreen.open(StringHelper.actions.TEXT[6], this.amount, false, false);
