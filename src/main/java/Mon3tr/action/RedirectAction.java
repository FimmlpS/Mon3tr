...
public class RedirectAction extends AbstractGameAction {
    private static final UIStrings uiStrings;
    public static final String[] TEXT;
    private AbstractPlayer p;

    public RedirectAction(AbstractCreature source) {
        ...
        if (AbstractDungeon.getCurrRoom().isBattleEnding()) {
            ...
            if (this.duration == Settings.ACTION_DUR_FASTER) {
                ...
                if (this.p.discardPile.size() == 1) {
                    ...
                    CardModifierManager.addModifier(tmp,new RedirectMod());
            ...
            if (!AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
                for(AbstractCard c : AbstractDungeon.gridSelectScreen.selectedCards) {
                    CardModifierManager.addModifier(c,new RedirectMod());
