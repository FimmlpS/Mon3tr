...
public class ShowCardAndAddToMeltdownEffect extends AbstractGameEffect {
    private static final float EFFECT_DUR = 0.8F;
    private AbstractCard card;
    private static final float PADDING;

    public ShowCardAndAddToMeltdownEffect(AbstractCard card, float offsetX, float offsetY) {
        this.card = card;
        ...
        MeltdownPatch.addToTop(card);
        card.triggerWhenCopied();
        MeltdownPatch.refreshMeltdownLayout();
        MeltdownPatch.applyPowers();
    ...
    public ShowCardAndAddToMeltdownEffect(AbstractCard card) {
        this.card = card;
    ...
    private void playCardObtainSfx() {
        ...
        while(var2.hasNext()) {
            ...
            if (e instanceof ShowCardAndAddToMeltdownEffect) {
                ++effectCount;
            }
        }
